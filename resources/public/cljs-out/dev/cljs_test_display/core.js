...
var len__4641__auto___9400 = arguments.length;
var i__4642__auto___9401 = (0);
while(true){
if((i__4642__auto___9401 < len__4641__auto___9400)){
args__4647__auto__.push((arguments[i__4642__auto___9401]));

var G__9402 = (i__4642__auto___9401 + (1));
i__4642__auto___9401 = G__9402;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq9397){
...
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9398,G__9399,seq9397__$2);
});
...
var id = cljs.core.nth.call(null,vec__9403,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__9403,(1),null);
var G__9406 = cljs.core.PersistentArrayMap.EMPTY;
var G__9406__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__9406,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9406);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__9406__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__9406__$1;
}
} else {
...
return (function() { 
var G__9410__delegate = function (klass,contents){
var vec__9407 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__9407,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__9407,(1),null);
...
var G__9410 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__9411__i = 0, G__9411__a = new Array(arguments.length -  1);
while (G__9411__i < G__9411__a.length) {G__9411__a[G__9411__i] = arguments[G__9411__i + 1]; ++G__9411__i;}
  contents = new cljs.core.IndexedSeq(G__9411__a,0,null);
} 
return G__9410__delegate.call(this,klass,contents);};
G__9410.cljs$lang$maxFixedArity = 1;
G__9410.cljs$lang$applyTo = (function (arglist__9412){
var klass = cljs.core.first(arglist__9412);
var contents = cljs.core.rest(arglist__9412);
return G__9410__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__9416){
...
var ns = cljs.core.get.call(null,map__9417__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__9417__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__9419){
...
var actual = cljs.core.get.call(null,map__9420__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__9420__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__9422){
...
var expected = cljs.core.get.call(null,map__9423__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__9423__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__9425_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__9427 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__9427__$1;
var name = cljs.core.get.call(null,map__9427__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__9427__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9427__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__9427,map__9427__$1,info,name,line,file,node){
return (function (p1__9426_SHARP_){
return cljs.core.cons.call(null,node,p1__9426_SHARP_);
});})(curr_node,map__9427,map__9427__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__9429){
...
var m = map__9430__$1;
var fail = cljs.core.get.call(null,map__9430__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__9430__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__9430__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__9430__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___9432 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___9432)){
var message_9433 = temp__5720__auto___9432;
cljs.core.println.call(null,message_9433);
} else {
}
...
var temp__5720__auto___9434 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___9434)){
var message_9435 = temp__5720__auto___9434;
cljs.core.println.call(null,message_9435);
} else {
}
