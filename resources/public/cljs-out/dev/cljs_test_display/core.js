...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq10316){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10317,G__10318,seq10316__$2);
});
...
var classes__$1 = cljs.core.nth.call(null,vec__10322,(1),null);
var G__10325 = cljs.core.PersistentArrayMap.EMPTY;
var G__10325__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__10325,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10325);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__10325__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__10325__$1;
}
} else {
...
return (function() { 
var G__10329__delegate = function (klass,contents){
var vec__10326 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__10326,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__10326,(1),null);
...
var G__10329 = function (klass,var_args){
var contents = null;
...
while (G__10330__i < G__10330__a.length) {G__10330__a[G__10330__i] = arguments[G__10330__i + 1]; ++G__10330__i;}
  contents = new cljs.core.IndexedSeq(G__10330__a,0,null);
} 
return G__10329__delegate.call(this,klass,contents);};
G__10329.cljs$lang$maxFixedArity = 1;
G__10329.cljs$lang$applyTo = (function (arglist__10331){
var klass = cljs.core.first(arglist__10331);
var contents = cljs.core.rest(arglist__10331);
return G__10329__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__10335){
var map__10336 = p__10335;
var map__10336__$1 = ((((!((map__10336 == null)))?(((((map__10336.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10336.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10336):map__10336);
var ns = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__10338){
...
var actual = cljs.core.get.call(null,map__10339__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__10339__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__10341){
var map__10342 = p__10341;
var map__10342__$1 = ((((!((map__10342 == null)))?(((((map__10342.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10342.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10342):map__10342);
var expected = cljs.core.get.call(null,map__10342__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__10342__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__10344_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__10346 = cljs_test_display.core.current_var_info.call(null);
...
var name = cljs.core.get.call(null,map__10346__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__10346__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10346__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__10346,map__10346__$1,info,name,line,file,node){
return (function (p1__10345_SHARP_){
return cljs.core.cons.call(null,node,p1__10345_SHARP_);
});})(curr_node,map__10346,map__10346__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__10348){
var map__10349 = p__10348;
var map__10349__$1 = ((((!((map__10349 == null)))?(((((map__10349.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10349.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10349):map__10349);
var m = map__10349__$1;
var fail = cljs.core.get.call(null,map__10349__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__10349__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__10349__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__10349__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___10351 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10351)){
var message_10352 = temp__5720__auto___10351;
cljs.core.println.call(null,message_10352);
} else {
}
...
var temp__5720__auto___10353 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10353)){
var message_10354 = temp__5720__auto___10353;
cljs.core.println.call(null,message_10354);
} else {
}
