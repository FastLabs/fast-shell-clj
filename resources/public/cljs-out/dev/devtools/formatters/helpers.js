...
var G__17476 = devtools.prefs.pref.call(null,v);
v = G__17476;
continue;
} else {
return v;
...
}catch (e17479){var _e__16491__auto__ = e17479;
return false;
}})();
...
}catch (e17483){var _e__16491__auto__ = e17483;
return false;
}})();
...
}catch (e17485){var _e__16491__auto__ = e17485;
return false;
}}
}
});
...
var vec__17487 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__17487,(0),null);
var name = cljs.core.nth.call(null,vec__17487,(1),null);
...
return cljs.core.some.call(null,(function (p1__17490_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__17490_SHARP_);
}),template);
});
