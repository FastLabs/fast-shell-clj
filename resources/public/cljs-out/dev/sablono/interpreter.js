...
var x14007_14008 = ctor.prototype;
x14007_14008.onChange = ((function (x14007_14008,ctor){
...
x14007_14008.componentWillReceiveProps = ((function (x14007_14008,ctor){
...
x14007_14008.render = ((function (x14007_14008,ctor){
return (function (){
var this$ = this;
...
switch (G__14012) {
case "input":
var G__14013 = (function (){var and__4036__auto__ = cljs.core.object_QMARK_.call(null,props);
if(and__4036__auto__){
return props.type;
} else {
return and__4036__auto__;
...
var len__4641__auto___14019 = arguments.length;
var i__4642__auto___14020 = (0);
while(true){
if((i__4642__auto___14020 < len__4641__auto___14019)){
args__4647__auto__.push((arguments[i__4642__auto___14020]));

var G__14021 = (i__4642__auto___14020 + (1));
i__4642__auto___14020 = G__14021;
continue;
} else {
}
break;
...
/** @this {Function} */
sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq14016){
...
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14017,G__14018,seq14016__$2);
});
...
var vec__14023 = sablono.normalize.element.call(null,element);
var type = cljs.core.nth.call(null,vec__14023,(0),null);
var attrs = cljs.core.nth.call(null,vec__14023,(1),null);
var content = cljs.core.nth.call(null,vec__14023,(2),null);
