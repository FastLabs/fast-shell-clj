...
var len__4531__auto___9366 = arguments.length;
var i__4532__auto___9367 = (0);
while(true){
if((i__4532__auto___9367 < len__4531__auto___9366)){
args__4534__auto__.push((arguments[i__4532__auto___9367]));

var G__9368 = (i__4532__auto___9367 + (1));
i__4532__auto___9367 = G__9368;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9363){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9364,G__9365,seq9363__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9369_SHARP_){
return !((cljs.core.meta.call(null,p1__9369_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__9370__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9374){var _e__8354__auto__ = e9374;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e9376){var _e__8354__auto__ = e9376;
return false;
}}
})())){
...
var _STAR_current_state_STAR_9378 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__9379 = opts;
...
var markup_db = cljs.core.get.call(null,map__9379__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_9378;
}});
...
;
var temp__5718__auto___9383 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___9383)){
var managed_print_level_9384 = temp__5718__auto___9383;
var _STAR_print_level_STAR_9382_9385 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_9384;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_9382_9385,managed_print_level_9384,temp__5718__auto___9383,writer,opts,job_fn){
return (function (p1__9381_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__9381_SHARP_,null);
});})(_STAR_print_level_STAR_9382_9385,managed_print_level_9384,temp__5718__auto___9383,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_9382_9385;
}} else {
job_fn.call(null);
}
