...
var o9235 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9235["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9236 = temp__5718__auto____$1;
return (o9236["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8347__auto__ = f;
return (o__8347__auto__["toString"]).call(o__8347__auto__);
} else {
return "";
}
}catch (e9237){var _ = e9237;
return "";
}});
...
try{var o__8347__auto___9239 = t;
(o__8347__auto___9239["cljs$lang$ctorPrWriter"]).call(o__8347__auto___9239,t,writer);
}catch (e9238){var __9240 = e9238;
}
...
var char_code = (function (){var o__8347__auto__ = (new String(char$));
return (o__8347__auto__["charCodeAt"]).call(o__8347__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8347__auto__ = String;
return (o__8347__auto__["fromCharCode"]).call(o__8347__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9241 = num_code;
switch (G__9241) {
case (1):
return (185);
...
var o__8347__auto__ = String;
return (o__8347__auto__["fromCharCode"]).call(o__8347__auto__,superscript_code);
});
/**
...
}catch (e9243){var _e__8354__auto__ = e9243;
return false;
}})())){
...
var vec__9244 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9244,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o9247 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9247["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9248 = temp__5718__auto____$1;
return (o9248["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___9255 = arguments.length;
var i__4532__auto___9256 = (0);
while(true){
if((i__4532__auto___9256 < len__4531__auto___9255)){
args__4534__auto__.push((arguments[i__4532__auto___9256]));

var G__9257 = (i__4532__auto___9256 + (1));
i__4532__auto___9256 = G__9257;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9251){
var vec__9252 = p__9251;
var ns_detector = cljs.core.nth.call(null,vec__9252,(0),null);
...
var G__9258 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9259 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9258;
remaining_tokens = G__9259;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9249){
...
var vec__9263 = cljs.core.split_with.call(null,(function (p1__9262_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9262_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9263,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9263,(1),null);
...
var vec__9266 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9266,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9266,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9269 = cljs.core.rest.call(null,remaining_tokens);
var G__9270 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9269;
name_tokens = G__9270;
continue;
} else {
...
var vec__9273 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9273,(0),null);
var arity = cljs.core.nth.call(null,vec__9273,(1),null);
var vec__9276 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9276,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9276,(1),null);
var vec__9279 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9279,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9279,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9279,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9279,(3),null);
...
var vec__9285 = result;
var munged_ns = cljs.core.nth.call(null,vec__9285,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9285,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9285,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9285,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9285,(4),null);
var arity = cljs.core.nth.call(null,vec__9285,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__9289 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__9289,(0),null);
var args = cljs.core.nth.call(null,vec__9289,(1),null);
var vec__9292 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__9292,(0),null);
var name = cljs.core.nth.call(null,vec__9292,(1),null);
...
var G__9295 = (arity + (1));
var G__9296 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9297){
var vec__9298 = p__9297;
var arity = cljs.core.nth.call(null,vec__9298,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9298,(1),null);
...
return cljs.core.get.call(null,arities,p1__9301_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__9302_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9305){
var vec__9306 = p__9305;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9306,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9303){
var G__9304 = cljs.core.first.call(null,seq9303);
var seq9303__$1 = cljs.core.next.call(null,seq9303);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9304,seq9303__$1);
});
...
var G__9312 = arg;
var G__9312__$1 = (((G__9312 instanceof cljs.core.Keyword))?G__9312.fqn:null);
switch (G__9312__$1) {
...
var map__9314 = options;
var map__9314__$1 = ((((!((map__9314 == null)))?(((((map__9314.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9314.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9314):map__9314);
var include_ns_QMARK_ = cljs.core.get.call(null,map__9314__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9314__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9314__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9314__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9315 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9315,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9315,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9315,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9315,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9315,(4),null);
var arity = cljs.core.nth.call(null,vec__9315,(5),null);
...
var o__8347__auto__ = f;
return (o__8347__auto__["getBasis"]).call(o__8347__auto__);
});
/**
...
}catch (e9319){var _e__8354__auto__ = e9319;
...
var G__9320 = (obj[cljs.core.first.call(null,path)]);
var G__9321 = cljs.core.rest.call(null,path);
obj = G__9320;
path = G__9321;
continue;
} else {
...
return (function (accum,p__9322){
var vec__9323 = p__9322;
var bit = cljs.core.nth.call(null,vec__9323,(0),null);
var protocol = cljs.core.nth.call(null,vec__9323,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9326){
var vec__9327 = p__9326;
var ns = cljs.core.nth.call(null,vec__9327,(0),null);
var name = cljs.core.nth.call(null,vec__9327,(1),null);
var selector = cljs.core.nth.call(null,vec__9327,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__9332,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9332,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__9332,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__9330_SHARP_){
return (obj[cljs.core.first.call(null,p1__9330_SHARP_)]);
});})(name,sorted_matches,vec__9332,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
