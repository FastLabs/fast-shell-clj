...
var G__11597 = devtools.prefs.pref.call(null,v);
v = G__11597;
continue;
} else {
return v;
...
}catch (e11600){var _e__10614__auto__ = e11600;
return false;
}})();
...
}catch (e11604){var _e__10614__auto__ = e11604;
return false;
}})();
...
}catch (e11606){var _e__10614__auto__ = e11606;
return false;
}}
}
});
...
var vec__11608 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11608,(0),null);
var name = cljs.core.nth.call(null,vec__11608,(1),null);
...
return cljs.core.some.call(null,(function (p1__11611_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11611_SHARP_);
}),template);
});
