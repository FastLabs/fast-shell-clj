...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11623){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11624,G__11625,seq11623__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11629_SHARP_){
return !((cljs.core.meta.call(null,p1__11629_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__11630__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11634){var _e__10614__auto__ = e11634;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e11636){var _e__10614__auto__ = e11636;
return false;
}}
})())){
...
var _STAR_current_state_STAR_11638 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__11639 = opts;
...
var markup_db = cljs.core.get.call(null,map__11639__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_11638;
}});
...
;
var temp__5718__auto___11643 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___11643)){
var managed_print_level_11644 = temp__5718__auto___11643;
var _STAR_print_level_STAR_11642_11645 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_11644;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_11642_11645,managed_print_level_11644,temp__5718__auto___11643,writer,opts,job_fn){
return (function (p1__11641_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__11641_SHARP_,null);
});})(_STAR_print_level_STAR_11642_11645,managed_print_level_11644,temp__5718__auto___11643,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_11642_11645;
}} else {
job_fn.call(null);
}
