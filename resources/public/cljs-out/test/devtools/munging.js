...
var o11495 = temp__5718__auto__;
var temp__5718__auto____$1 = (o11495["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o11496 = temp__5718__auto____$1;
return (o11496["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10607__auto__ = f;
return (o__10607__auto__["toString"]).call(o__10607__auto__);
} else {
return "";
}
}catch (e11497){var _ = e11497;
return "";
}});
...
try{var o__10607__auto___11499 = t;
(o__10607__auto___11499["cljs$lang$ctorPrWriter"]).call(o__10607__auto___11499,t,writer);
}catch (e11498){var __11500 = e11498;
}
...
var char_code = (function (){var o__10607__auto__ = (new String(char$));
return (o__10607__auto__["charCodeAt"]).call(o__10607__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10607__auto__ = String;
return (o__10607__auto__["fromCharCode"]).call(o__10607__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11501 = num_code;
switch (G__11501) {
case (1):
return (185);
...
var o__10607__auto__ = String;
return (o__10607__auto__["fromCharCode"]).call(o__10607__auto__,superscript_code);
});
/**
...
}catch (e11503){var _e__10614__auto__ = e11503;
return false;
}})())){
...
var vec__11504 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11504,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o11507 = temp__5718__auto__;
var temp__5718__auto____$1 = (o11507["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o11508 = temp__5718__auto____$1;
return (o11508["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11511){
var vec__11512 = p__11511;
var ns_detector = cljs.core.nth.call(null,vec__11512,(0),null);
...
var G__11518 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11519 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11518;
remaining_tokens = G__11519;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11509){
var G__11510 = cljs.core.first.call(null,seq11509);
var seq11509__$1 = cljs.core.next.call(null,seq11509);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11510,seq11509__$1);
});
...
var vec__11523 = cljs.core.split_with.call(null,(function (p1__11522_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11522_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11523,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11523,(1),null);
...
var vec__11526 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11526,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11526,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11529 = cljs.core.rest.call(null,remaining_tokens);
var G__11530 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11529;
name_tokens = G__11530;
continue;
} else {
...
var vec__11533 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11533,(0),null);
var arity = cljs.core.nth.call(null,vec__11533,(1),null);
var vec__11536 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11536,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11536,(1),null);
var vec__11539 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11539,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11539,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11539,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11539,(3),null);
...
var vec__11545 = result;
var munged_ns = cljs.core.nth.call(null,vec__11545,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11545,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11545,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11545,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11545,(4),null);
var arity = cljs.core.nth.call(null,vec__11545,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__11549 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__11549,(0),null);
var args = cljs.core.nth.call(null,vec__11549,(1),null);
var vec__11552 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__11555 = (arity + (1));
var G__11556 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11557){
var vec__11558 = p__11557;
var arity = cljs.core.nth.call(null,vec__11558,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11558,(1),null);
...
return cljs.core.get.call(null,arities,p1__11561_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__11562_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___11569 = arguments.length;
var i__4532__auto___11570 = (0);
while(true){
if((i__4532__auto___11570 < len__4531__auto___11569)){
args__4534__auto__.push((arguments[i__4532__auto___11570]));

var G__11571 = (i__4532__auto___11570 + (1));
i__4532__auto___11570 = G__11571;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11565){
var vec__11566 = p__11565;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11566,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11563){
...
var G__11572 = arg;
var G__11572__$1 = (((G__11572 instanceof cljs.core.Keyword))?G__11572.fqn:null);
switch (G__11572__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__11574__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11574__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11574__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11574__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11575 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11575,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11575,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11575,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11575,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11575,(4),null);
var arity = cljs.core.nth.call(null,vec__11575,(5),null);
...
var o__10607__auto__ = f;
return (o__10607__auto__["getBasis"]).call(o__10607__auto__);
});
/**
...
}catch (e11579){var _e__10614__auto__ = e11579;
...
var G__11580 = (obj[cljs.core.first.call(null,path)]);
var G__11581 = cljs.core.rest.call(null,path);
obj = G__11580;
path = G__11581;
continue;
} else {
...
return (function (accum,p__11582){
var vec__11583 = p__11582;
var bit = cljs.core.nth.call(null,vec__11583,(0),null);
var protocol = cljs.core.nth.call(null,vec__11583,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11586){
var vec__11587 = p__11586;
var ns = cljs.core.nth.call(null,vec__11587,(0),null);
var name = cljs.core.nth.call(null,vec__11587,(1),null);
var selector = cljs.core.nth.call(null,vec__11587,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__11592,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11592,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__11592,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__11590_SHARP_){
return (obj[cljs.core.first.call(null,p1__11590_SHARP_)]);
});})(name,sorted_matches,vec__11592,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
